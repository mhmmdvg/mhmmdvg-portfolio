...
const Socmed: NextPage = () => {
  return (
    <section className="bg-black text-white pt-2 pb-20 flex">
      <div className="container mx-auto">
        <div className=" w-56 md:w-96 mx-auto text-white mt-10">
          <div className="flex flex-row justify-between bg-[#141414] py-2 px-3 md:py-3 md:px-12 rounded-2xl">
