  ...
  return (
    <footer>
      <div className="w-screen border-t mt-24 bg-[#fafafa] border-[#eaeaea] dark:bg-[#111] dark:border-[#292929]">
        <div className="container mx-auto flex flex-col justify-center py-8 text-center text-[#666666] dark:text-[#848484]">
          <div className="flex flex-row justify-center items-center space-x-2">
            <div className="w-6 sm:w-8 xl:w-9 lg:w-10">
              <M />
            </div>
            <p className="text-black dark:text-white font-display font-bold text-xl">
              Mhmmdvg
            </p>
          </div>
