...
const TechToolsItem: NextPage<ToolsItemProps> = (props) => {
  ...
  return (
    // border light DFDFDF
    <div className=" flex items-center cursor-pointer justify-center w-32 h-24 md:w-64 md:h-24 lg:w-48 lg:h-24 xl:w-64 xl:h-24 rounded-lg border dark:border-[#383838] border-[#eaeaea] transition-all ease-in-out hover:-translate-y-0 hover:scale-110 duration-200">
