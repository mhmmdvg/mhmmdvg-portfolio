...
const twstyles = {
  body: 'dark:bg-black bg-white transition pt-20 sm:pt-28',
  container:
    'flex flex-wrap flex-col items-start mt-10 px-3 lg:px-24 2xl:px-60 sm:items-start sm:justify-start sm:w-full ',
  title:
